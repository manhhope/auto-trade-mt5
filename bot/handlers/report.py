...
async def cmd_report(message: Message):
    ...
    try:
        ...
        summary = await api_client.get_report_summary(period, tg_user_id=message.from_user.id)
        ...
        trend = await api_client.get_report_trend(weeks_to_compare, tg_user_id=message.from_user.id)
